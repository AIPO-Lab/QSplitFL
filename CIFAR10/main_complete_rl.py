...
print("="*80)
print("CAPABILITY-AWARE Q-LEARNING FOR SPLIT POINT OPTIMIZATION")
print("="*80)
print(f"\nConfiguration:")
...
model_instance, model_display_name = get_model_by_choice(
    model_choice, 10, input_channels=3
)

# Initialize server with selected model
server = Server(10, model_instance, cifar_test_dataset)
...
axes[2, 0].set_title('Exploration Rate Decay')
...
plt.tight_layout()
plt.savefig('./complete_rl_results.png', dpi=150, bbox_inches='tight')
print(" Results saved to 'complete_rl_results.png'")
